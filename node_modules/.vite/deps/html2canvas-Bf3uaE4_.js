import { t as __commonJS } from "./chunk-DNXwb8T0.js";

//#region node_modules/html2canvas/dist/html2canvas.js
var require_html2canvas = /* @__PURE__ */ __commonJS({ "node_modules/html2canvas/dist/html2canvas.js": ((exports, module) => {
	(function(global, factory) {
		...
		var __assign = function() {
			__assign = Object.assign || function __assign$1(t) {
				for (var s, i$4 = 1, n = arguments.length; i$4 < n; i$4++) {
					s = arguments[i$4];
		...
		function __generator(thisArg, body) {
			...
			function step(op) {
				...
				while (_) try {
					if (f$1 = 1, y && (t = op[0] & 2 ? y["return"] : op[0] ? y["throw"] || ((t = y["return"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;
		...
		function __spreadArray(to, from, pack$1) {
			if (pack$1 || arguments.length === 2) {
				for (var i$4 = 0, l = from.length, ar; i$4 < l; i$4++) if (ar || !(i$4 in from)) {
					if (!ar) ar = Array.prototype.slice.call(from, 0, i$4);
					ar[i$4] = from[i$4];
				}
			}
		...
		var Bounds = function() {
			function Bounds$1(left, top, width, height) {
				this.left = left;
				this.top = top;
				this.width = width;
				this.height = height;
			}
			Bounds$1.prototype.add = function(x, y, w, h) {
				return new Bounds$1(this.left + x, this.top + y, this.width + w, this.height + h);
			};
			Bounds$1.fromClientRect = function(context, clientRect) {
				return new Bounds$1(clientRect.left + context.windowBounds.left, clientRect.top + context.windowBounds.top, clientRect.width, clientRect.height);
			};
			Bounds$1.fromDOMRectList = function(context, domRectList) {
				var domRect = Array.from(domRectList).find(function(rect) {
					return rect.width !== 0;
				});
				return domRect ? new Bounds$1(domRect.left + context.windowBounds.left, domRect.top + context.windowBounds.top, domRect.width, domRect.height) : Bounds$1.EMPTY;
			};
			Bounds$1.EMPTY = new Bounds$1(0, 0, 0, 0);
			return Bounds$1;
		}();
		var parseBounds = function(context, node) {
			return Bounds.fromClientRect(context, node.getBoundingClientRect());
		};
		var parseDocumentSize = function(document$1) {
		...
		var toCodePoints$1 = function(str) {
			...
			while (i$4 < length) {
				var value = str.charCodeAt(i$4++);
				if (value >= 55296 && value <= 56319 && i$4 < length) {
					var extra = str.charCodeAt(i$4++);
		...
		var decode$1 = function(base64$2) {
			var bufferLength = base64$2.length * .75, len = base64$2.length, i$4, p = 0, encoded1, encoded2, encoded3, encoded4;
			if (base64$2[base64$2.length - 1] === "=") {
				bufferLength--;
				if (base64$2[base64$2.length - 2] === "=") bufferLength--;
			}
			var buffer = typeof ArrayBuffer !== "undefined" && typeof Uint8Array !== "undefined" && typeof Uint8Array.prototype.slice !== "undefined" ? new ArrayBuffer(bufferLength) : new Array(bufferLength);
			var bytes = Array.isArray(buffer) ? buffer : new Uint8Array(buffer);
			for (i$4 = 0; i$4 < len; i$4 += 4) {
				encoded1 = lookup$1$1[base64$2.charCodeAt(i$4)];
				encoded2 = lookup$1$1[base64$2.charCodeAt(i$4 + 1)];
				encoded3 = lookup$1$1[base64$2.charCodeAt(i$4 + 2)];
				encoded4 = lookup$1$1[base64$2.charCodeAt(i$4 + 3)];
		...
		var polyUint16Array$1 = function(buffer) {
			...
			var bytes = [];
			for (var i$4 = 0; i$4 < length; i$4 += 2) bytes.push(buffer[i$4 + 1] << 8 | buffer[i$4]);
			return bytes;
		};
		var polyUint32Array$1 = function(buffer) {
			var length = buffer.length;
			var bytes = [];
			for (var i$4 = 0; i$4 < length; i$4 += 4) bytes.push(buffer[i$4 + 3] << 24 | buffer[i$4 + 2] << 16 | buffer[i$4 + 1] << 8 | buffer[i$4]);
			return bytes;
		};
		...
		*/
		...
		var createTrieFromBase64$1 = function(base64$2, _byteLength) {
			var buffer = decode$1(base64$2);
		...
		var Trie$1 = function() {
			function Trie$2(initialValue, errorValue, highStart, highValueIndex, index, data) {
			...
			* @return the value
			*/
			Trie$2.prototype.get = function(codePoint) {
				var ix;
				if (codePoint >= 0) {
		...
		var HYPHEN = [HY, BA];
		var codePointsToCharacterClasses = function(codePoints, lineBreak$1) {
			if (lineBreak$1 === void 0) lineBreak$1 = "strict";
			var types = [];
			var indices = [];
			var categories = [];
			codePoints.forEach(function(codePoint, index) {
				...
				indices.push(index);
				if (classType === CJ) return types.push(lineBreak$1 === "strict" ? NS : ID);
		...
		var isAdjacentWithSpaceIgnored = function(a$1, b, currentIndex, classTypes) {
			var current = classTypes[currentIndex];
			if (Array.isArray(a$1) ? a$1.indexOf(current) !== -1 : a$1 === current) {
				var i$4 = currentIndex;
				while (i$4 <= classTypes.length) {
					i$4++;
					var next = classTypes[i$4];
			...
			if (current === SP) {
				...
				while (i$4 > 0) {
					i$4--;
					var prev = classTypes[i$4];
					if (Array.isArray(a$1) ? a$1.indexOf(prev) !== -1 : a$1 === prev) {
						var n = currentIndex;
		...
		var _lineBreakAtIndex = function(codePoints, classTypes, indicies, index, forbiddenBreaks) {
			...
			if (current === RI$1 && next === RI$1) {
				var i$4 = indicies[currentIndex];
				var count = 1;
				while (i$4 > 0) {
					i$4--;
					if (classTypes[i$4] === RI$1) count++;
					else break;
				}
		...
		var cssFormattedClasses = function(codePoints, options) {
			...
			var forbiddenBreakpoints = options.wordBreak === "keep-all" ? isLetterNumber.map(function(letterNumber, i$4) {
				return letterNumber && codePoints[i$4] >= 19968 && codePoints[i$4] <= 40959;
			}) : void 0;
			return [
				indicies,
				classTypes,
		...
		var Break = function() {
			function Break$1(codePoints, lineBreak$1, start, end) {
				this.codePoints = codePoints;
				this.required = lineBreak$1 === BREAK_MANDATORY;
				this.start = start;
				this.end = end;
			}
			Break$1.prototype.slice = function() {
		...
		var LineBreaker = function(str, options) {
			...
			return { next: function() {
				...
				var lineBreak$1 = BREAK_NOT_ALLOWED$1;
				while (nextIndex < length && (lineBreak$1 = _lineBreakAtIndex(codePoints, classTypes, indicies, ++nextIndex, forbiddenBreakpoints)) === BREAK_NOT_ALLOWED$1);
				if (lineBreak$1 !== BREAK_NOT_ALLOWED$1 || nextIndex === length) {
					var value = new Break(codePoints, lineBreak$1, lastEnd, nextIndex);
					lastEnd = nextIndex;
					return {
						value,
						done: false
		...
		var Tokenizer = function() {
			...
			Tokenizer$1.prototype.read = function() {
				var tokens = [];
			...
			Tokenizer$1.prototype.consumeToken = function() {
			...
			Tokenizer$1.prototype.consumeCodePoint = function() {
				var value = this._value.shift();
				return typeof value === "undefined" ? -1 : value;
			};
			Tokenizer$1.prototype.reconsumeCodePoint = function(codePoint) {
				this._value.unshift(codePoint);
			};
			Tokenizer$1.prototype.peekCodePoint = function(delta) {
				if (delta >= this._value.length) return -1;
				return this._value[delta];
			};
			Tokenizer$1.prototype.consumeUnicodeRangeToken = function() {
				var digits = [];
				var codePoint = this.consumeCodePoint();
			...
			Tokenizer$1.prototype.consumeIdentLikeToken = function() {
				var value = this.consumeName();
			...
			Tokenizer$1.prototype.consumeUrlToken = function() {
				var value = [];
				this.consumeWhiteSpace();
			...
			Tokenizer$1.prototype.consumeWhiteSpace = function() {
				while (isWhiteSpace(this.peekCodePoint(0))) this.consumeCodePoint();
			};
			Tokenizer$1.prototype.consumeBadUrlRemnants = function() {
				while (true) {
					var codePoint = this.consumeCodePoint();
			...
			Tokenizer$1.prototype.consumeStringSlice = function(count) {
			...
			Tokenizer$1.prototype.consumeStringToken = function(endingCodePoint) {
				var value = "";
				var i$4 = 0;
				do {
					var codePoint = this._value[i$4];
					if (codePoint === EOF || codePoint === void 0 || codePoint === endingCodePoint) {
						value += this.consumeStringSlice(i$4);
						return {
							type: 0,
							value
						};
					...
					if (codePoint === LINE_FEED) {
						this._value.splice(0, i$4);
						return BAD_STRING_TOKEN;
					}
					if (codePoint === REVERSE_SOLIDUS) {
						var next = this._value[i$4 + 1];
			...
			Tokenizer$1.prototype.consumeNumber = function() {
				var repr = [];
			...
			Tokenizer$1.prototype.consumeNumericToken = function() {
			...
			Tokenizer$1.prototype.consumeEscapedCodePoint = function() {
				var codePoint = this.consumeCodePoint();
				if (isHex(codePoint)) {
			...
			Tokenizer$1.prototype.consumeName = function() {
				var result = "";
				while (true) {
					var codePoint = this.consumeCodePoint();
		...
		var Parser = function() {
			function Parser$1(tokens) {
				this._tokens = tokens;
			}
			Parser$1.create = function(value) {
				var tokenizer = new Tokenizer();
				tokenizer.write(value);
				return new Parser$1(tokenizer.read());
			};
			Parser$1.parseValue = function(value) {
				return Parser$1.create(value).parseComponentValue();
			};
			Parser$1.parseValues = function(value) {
				return Parser$1.create(value).parseComponentValues();
			};
			Parser$1.prototype.parseComponentValue = function() {
				var token = this.consumeToken();
			...
			Parser$1.prototype.parseComponentValues = function() {
				var values = [];
				while (true) {
					var value = this.consumeComponentValue();
			...
			Parser$1.prototype.consumeComponentValue = function() {
				var token = this.consumeToken();
				switch (token.type) {
					case 11:
					case 28:
			...
			Parser$1.prototype.consumeSimpleBlock = function(type) {
				var block = {
					type,
					values: []
				};
			...
			Parser$1.prototype.consumeFunction = function(functionToken) {
				var cssFunction = {
			...
			Parser$1.prototype.consumeToken = function() {
				var token = this._tokens.shift();
				return typeof token === "undefined" ? EOF_TOKEN : token;
			};
			Parser$1.prototype.reconsumeToken = function(token) {
		...
		var deg = function(deg$1) {
			return Math.PI * deg$1 / 180;
		};
		var color$1 = {
			name: "color",
			parse: function(context, value) {
				...
				if (value.type === 5) {
					...
					if (value.value.length === 4) {
						...
						var g = value.value.substring(1, 2);
						var b = value.value.substring(2, 3);
						var a$1 = value.value.substring(3, 4);
						return pack(parseInt(r + r, 16), parseInt(g + g, 16), parseInt(b + b, 16), parseInt(a$1 + a$1, 16) / 255);
					}
					...
					if (value.value.length === 8) {
						...
						var g = value.value.substring(2, 4);
						var b = value.value.substring(4, 6);
						var a$1 = value.value.substring(6, 8);
						return pack(parseInt(r, 16), parseInt(g, 16), parseInt(b, 16), parseInt(a$1, 16) / 255);
					}
				}
				if (value.type === 20) {
		...
		var isTransparent = function(color$2) {
			return (255 & color$2) === 0;
		};
		var asString = function(color$2) {
			var alpha = 255 & color$2;
			var blue = 255 & color$2 >> 8;
			var green = 255 & color$2 >> 16;
			var red = 255 & color$2 >> 24;
			return alpha < 255 ? "rgba(" + red + "," + green + "," + blue + "," + alpha / 255 + ")" : "rgb(" + red + "," + green + "," + blue + ")";
		};
		var pack = function(r, g, b, a$1) {
			return (r << 24 | g << 16 | b << 8 | Math.round(a$1 * 255) << 0) >>> 0;
		};
		var getTokenColorValue = function(token, i$4) {
			if (token.type === 17) return token.number;
			if (token.type === 16) {
				var max = i$4 === 3 ? 1 : 255;
				return i$4 === 3 ? token.number / 100 * max : Math.round(token.number / 100 * max);
			}
			return 0;
		};
		var rgb = function(_context, args) {
			...
			if (tokens.length === 4) {
				var _b = tokens.map(getTokenColorValue), r = _b[0], g = _b[1], b = _b[2], a$1 = _b[3];
				return pack(r, g, b, a$1);
			}
			return 0;
		};
		...
		var hsl = function(context, args) {
			...
			var a$1 = typeof alpha !== "undefined" && isLengthPercentage(alpha) ? getAbsoluteValue(alpha, 1) : 1;
			...
			return pack(r * 255, g * 255, b * 255, a$1);
		};
		...
		var parseColorStop = function(context, args) {
			var color$2 = color$1.parse(context, args[0]);
			var stop = args[1];
		...
		var processColorStops = function(stops, lineLength) {
			...
			var processStops = [];
			var previous = 0;
			for (var i$4 = 0; i$4 < stops.length; i$4++) {
				var stop_1 = stops[i$4].stop;
				if (stop_1 !== null) {
			...
			var gapBegin = null;
			for (var i$4 = 0; i$4 < processStops.length; i$4++) {
				var stop_2 = processStops[i$4];
				if (stop_2 === null) {
					if (gapBegin === null) gapBegin = i$4;
				} else if (gapBegin !== null) {
					var gapLength = i$4 - gapBegin;
					var gapValue = (stop_2 - processStops[gapBegin - 1]) / (gapLength + 1);
					for (var g = 1; g <= gapLength; g++) processStops[gapBegin + g - 1] = gapValue * g;
					gapBegin = null;
				}
			}
			return stops.map(function(_a, i$5) {
				return {
					color: _a.color,
					stop: Math.max(Math.min(1, processStops[i$5] / lineLength), 0)
				};
			});
		};
		...
		var calculateGradientDirection = function(angle$1, width, height) {
			var radian = typeof angle$1 === "number" ? angle$1 : getAngleFromCorner(angle$1, width, height);
		...
		var distance = function(a$1, b) {
			return Math.sqrt(a$1 * a$1 + b * b);
		};
		...
		var linearGradient = function(context, tokens) {
			var angle$1 = deg(180);
			var stops = [];
			parseFunctionArgs(tokens).forEach(function(arg, i$4) {
				if (i$4 === 0) {
			...
			parseFunctionArgs(tokens).forEach(function(arg, i$4) {
				...
				if (firstToken.type === 18) {
					if (firstToken.name === "from") {
						var color$2 = color$1.parse(context, firstToken.values[0]);
						stops.push({
							stop: ZERO_LENGTH,
							color: color$2
						});
						...
						if (values.length === 2) {
							var color$2 = color$1.parse(context, values[1]);
							var stop_1 = values[0];
				...
				if (i$4 === 0) {
					...
					isColorStop = arg.reduce(function(acc, token) {
						if (isAtPosition_1) {
							if (isIdentToken(token)) switch (token.value) {
								case "center":
									position$1.push(FIFTY_PERCENT);
									return acc;
								case "top":
								case "left":
									position$1.push(ZERO_LENGTH);
									return acc;
								case "right":
								case "bottom":
									position$1.push(HUNDRED_PERCENT);
									return acc;
							}
							else if (isLengthPercentage(token) || isLength(token)) position$1.push(token);
		...
		var prefixRadialGradient = function(context, tokens) {
			...
			parseFunctionArgs(tokens).forEach(function(arg, i$4) {
				var isColorStop = true;
				if (i$4 === 0) isColorStop = arg.reduce(function(acc, token) {
					if (isIdentToken(token)) switch (token.value) {
						case "center":
							position$1.push(FIFTY_PERCENT);
							return false;
						...
						position$1.push(token);
						return false;
					}
					return acc;
				}, isColorStop);
				else if (i$4 === 1) isColorStop = arg.reduce(function(acc, token) {
					if (isIdentToken(token)) switch (token.value) {
						case CIRCLE:
							shape = 0;
							return false;
		...
		var BACKGROUND_SIZE;
		(function(BACKGROUND_SIZE$1) {
			BACKGROUND_SIZE$1["AUTO"] = "auto";
			BACKGROUND_SIZE$1["CONTAIN"] = "contain";
			BACKGROUND_SIZE$1["COVER"] = "cover";
		...
		var direction = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, direction$1) {
				switch (direction$1) {
					case "rtl": return 1;
					case "ltr":
					default: return 0;
		...
		var parseDisplayValue = function(display$1) {
			switch (display$1) {
				case "block":
		...
		var float = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, float$1) {
				switch (float$1) {
					case "left": return 1;
					case "right": return 2;
		...
		var LINE_BREAK;
		(function(LINE_BREAK$1) {
			LINE_BREAK$1["NORMAL"] = "normal";
			LINE_BREAK$1["STRICT"] = "strict";
		...
		var lineBreak = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, lineBreak$1) {
				switch (lineBreak$1) {
		...
		var computeLineHeight = function(token, fontSize$1) {
			if (isIdentToken(token) && token.value === "normal") return 1.2 * fontSize$1;
			else if (token.type === 17) return fontSize$1 * token.number;
			else if (isLengthPercentage(token)) return getAbsoluteValue(token, fontSize$1);
			return fontSize$1;
		};
		var listStyleImage = {
		...
		var listStylePosition = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, position$1) {
				switch (position$1) {
		...
		var overflow = {
			...
			type: 1,
			parse: function(_context, tokens) {
				return tokens.filter(isIdentToken).map(function(overflow$1) {
					switch (overflow$1.value) {
		...
		var overflowWrap = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, overflow$1) {
				switch (overflow$1) {
		...
		var textAlign = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, textAlign$1) {
				switch (textAlign$1) {
					case "right": return 2;
					case "center":
		...
		var textShadow = {
			...
			parse: function(context, tokens) {
				...
				return parseFunctionArgs(tokens).map(function(values) {
					...
					var c = 0;
					for (var i$4 = 0; i$4 < values.length; i$4++) {
						var token = values[i$4];
						if (isLength(token)) {
		...
		var textTransform = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, textTransform$1) {
		...
		var visibility = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, visibility$1) {
				switch (visibility$1) {
					case "hidden": return 1;
		...
		var WORD_BREAK;
		(function(WORD_BREAK$1) {
			WORD_BREAK$1["NORMAL"] = "normal";
			WORD_BREAK$1["BREAK_ALL"] = "break-all";
			WORD_BREAK$1["KEEP_ALL"] = "keep-all";
		...
		var wordBreak = {
			...
			prefix: false,
			type: 2,
			parse: function(_context, wordBreak$1) {
				switch (wordBreak$1) {
		...
		var counterIncrement = {
			...
			parse: function(_context, tokens) {
				...
				for (var i$4 = 0; i$4 < filtered.length; i$4++) {
					var counter = filtered[i$4];
					var next = filtered[i$4 + 1];
					if (counter.type === 20) {
		...
		var quotes = {
			...
			parse: function(_context, tokens) {
				...
				for (var i$4 = 0; i$4 < filtered.length; i$4 += 2) {
					var open_1 = filtered[i$4].value;
					var close_1 = filtered[i$4 + 1].value;
					quotes$1.push({
						open: open_1,
						close: close_1
					});
		...
		var getQuote = function(quotes$1, depth, open) {
			if (!quotes$1) return "";
			var quote = quotes$1[Math.min(depth, quotes$1.length - 1)];
			if (!quote) return "";
		...
		var paintOrder = {
			...
			parse: function(_context, tokens) {
				...
				DEFAULT_VALUE$1.forEach(function(value) {
		...
		var CSSParsedDeclaration = function() {
			function CSSParsedDeclaration$1(context, declaration) {
				var _a, _b;
			...
			CSSParsedDeclaration$1.prototype.isVisible = function() {
				return this.display > 0 && this.opacity > 0 && this.visibility === 0;
			};
			CSSParsedDeclaration$1.prototype.isTransparent = function() {
				return isTransparent(this.backgroundColor);
			};
			CSSParsedDeclaration$1.prototype.isTransformed = function() {
				return this.transform !== null;
			};
			CSSParsedDeclaration$1.prototype.isPositioned = function() {
				return this.position !== 0;
			};
			CSSParsedDeclaration$1.prototype.isPositionedWithZIndex = function() {
				return this.isPositioned() && !this.zIndex.auto;
			};
			CSSParsedDeclaration$1.prototype.isFloating = function() {
				return this.float !== 0;
			};
			CSSParsedDeclaration$1.prototype.isInlineLevel = function() {
			...
			return CSSParsedDeclaration$1;
		}();
		var CSSParsedPseudoDeclaration = function() {
			function CSSParsedPseudoDeclaration$1(context, declaration) {
				this.content = parse(context, content, declaration.content);
				this.quotes = parse(context, quotes, declaration.quotes);
			}
			return CSSParsedPseudoDeclaration$1;
		}();
		var CSSParsedCounterDeclaration = function() {
			function CSSParsedCounterDeclaration$1(context, declaration) {
				this.counterIncrement = parse(context, counterIncrement, declaration.counterIncrement);
				this.counterReset = parse(context, counterReset, declaration.counterReset);
			}
			return CSSParsedCounterDeclaration$1;
		}();
		...
		var ElementContainer = function() {
			function ElementContainer$1(context, element) {
				...
				if (isHTMLElementNode(element)) {
					if (this.styles.animationDuration.some(function(duration$1) {
						return duration$1 > 0;
		...
		var decode = function(base64$2) {
			...
			var bytes = Array.isArray(buffer) ? buffer : new Uint8Array(buffer);
			for (i$4 = 0; i$4 < len; i$4 += 4) {
				encoded1 = lookup$1[base64$2.charCodeAt(i$4)];
				encoded2 = lookup$1[base64$2.charCodeAt(i$4 + 1)];
				encoded3 = lookup$1[base64$2.charCodeAt(i$4 + 2)];
				encoded4 = lookup$1[base64$2.charCodeAt(i$4 + 3)];
				bytes[p++] = encoded1 << 2 | encoded2 >> 4;
				bytes[p++] = (encoded2 & 15) << 4 | encoded3 >> 2;
				bytes[p++] = (encoded3 & 3) << 6 | encoded4 & 63;
			}
		...
		*/
		...
		var createTrieFromBase64 = function(base64$2, _byteLength) {
			var buffer = decode(base64$2);
		...
		var testRangeBounds = function(document$1) {
			var TEST_HEIGHT = 123;
			if (document$1.createRange) {
				var range = document$1.createRange();
				if (range.getBoundingClientRect) {
					var testElement = document$1.createElement("boundtest");
					testElement.style.height = TEST_HEIGHT + "px";
					testElement.style.display = "block";
					document$1.body.appendChild(testElement);
					range.selectNode(testElement);
					var rangeBounds = range.getBoundingClientRect();
					var rangeHeight = Math.round(rangeBounds.height);
					document$1.body.removeChild(testElement);
					if (rangeHeight === TEST_HEIGHT) return true;
				}
			}
			return false;
		};
		var testIOSLineBreak = function(document$1) {
			var testElement = document$1.createElement("boundtest");
			...
			var textList = toCodePoints$1(node.data).map(function(i$4) {
				return fromCodePoint$1(i$4);
			});
			var offset = 0;
			var prev = {};
			var supports = textList.every(function(text, i$4) {
		...
		var testSVG = function(document$1) {
			var img = new Image();
		...
		var testForeignObject = function(document$1) {
			var canvas = document$1.createElement("canvas");
			var size = 100;
			canvas.width = size;
			canvas.height = size;
			...
			ctx.fillStyle = "red";
			ctx.fillRect(0, 0, size, size);
			return loadSerializedSVG$1(svg).then(function(img$1) {
				ctx.drawImage(img$1, 0, 0);
				var data = ctx.getImageData(0, 0, size, size).data;
				ctx.fillStyle = "red";
				ctx.fillRect(0, 0, size, size);
				var node = document$1.createElement("div");
		...
		var TextBounds = function() {
			function TextBounds$1(text, bounds) {
				this.text = text;
				this.bounds = bounds;
			}
			return TextBounds$1;
		...
		var TextContainer = function() {
			function TextContainer$1(context, node, styles) {
				this.text = transform(node.data, styles.textTransform);
				this.textBounds = parseTextBounds(context, this.text, styles, node);
			}
			return TextContainer$1;
		}();
		var transform = function(text, transform$2) {
			switch (transform$2) {
		...
		var ImageElementContainer = function(_super) {
			__extends(ImageElementContainer$1, _super);
			function ImageElementContainer$1(context, img) {
			...
			return ImageElementContainer$1;
		}(ElementContainer);
		var CanvasElementContainer = function(_super) {
			__extends(CanvasElementContainer$1, _super);
			function CanvasElementContainer$1(context, canvas) {
			...
			return CanvasElementContainer$1;
		}(ElementContainer);
		var SVGElementContainer = function(_super) {
			__extends(SVGElementContainer$1, _super);
			function SVGElementContainer$1(context, img) {
				var _this = _super.call(this, context, img) || this;
			...
			return SVGElementContainer$1;
		}(ElementContainer);
		var LIElementContainer = function(_super) {
			__extends(LIElementContainer$1, _super);
			function LIElementContainer$1(context, element) {
				var _this = _super.call(this, context, element) || this;
				_this.value = element.value;
				return _this;
			}
			return LIElementContainer$1;
		}(ElementContainer);
		var OLElementContainer = function(_super) {
			__extends(OLElementContainer$1, _super);
			function OLElementContainer$1(context, element) {
				var _this = _super.call(this, context, element) || this;
				_this.start = element.start;
				_this.reversed = typeof element.reversed === "boolean" && element.reversed === true;
				return _this;
			}
			return OLElementContainer$1;
		}(ElementContainer);
		...
		var InputElementContainer = function(_super) {
			__extends(InputElementContainer$1, _super);
			function InputElementContainer$1(context, input) {
			...
			return InputElementContainer$1;
		}(ElementContainer);
		var SelectElementContainer = function(_super) {
			__extends(SelectElementContainer$1, _super);
			function SelectElementContainer$1(context, element) {
				var _this = _super.call(this, context, element) || this;
				var option = element.options[element.selectedIndex || 0];
				_this.value = option ? option.text || "" : "";
				return _this;
			}
			return SelectElementContainer$1;
		}(ElementContainer);
		var TextareaElementContainer = function(_super) {
			__extends(TextareaElementContainer$1, _super);
			function TextareaElementContainer$1(context, element) {
				var _this = _super.call(this, context, element) || this;
				_this.value = element.value;
				return _this;
			}
			return TextareaElementContainer$1;
		}(ElementContainer);
		var IFrameElementContainer = function(_super) {
			__extends(IFrameElementContainer$1, _super);
			function IFrameElementContainer$1(context, iframe) {
			...
			return IFrameElementContainer$1;
		}(ElementContainer);
		var LIST_OWNERS = [
			"OL",
			"UL",
		...
		var parseNodeTree = function(context, node, parent, root) {
			for (var childNode = node.firstChild, nextNode = void 0; childNode; childNode = nextNode) {
				...
				else if (isElementNode(childNode)) if (isSlotElement(childNode) && childNode.assignedNodes) childNode.assignedNodes().forEach(function(childNode$1) {
					return parseNodeTree(context, childNode$1, parent, root);
				});
				else {
		...
		var CounterState = function() {
			function CounterState$1() {
				this.counters = {};
			}
			CounterState$1.prototype.getCounterValue = function(name) {
				var counter = this.counters[name];
				if (counter && counter.length) return counter[counter.length - 1];
				return 1;
			};
			CounterState$1.prototype.getCounterValues = function(name) {
				var counter = this.counters[name];
				return counter ? counter : [];
			};
			CounterState$1.prototype.pop = function(counters) {
				var _this = this;
				counters.forEach(function(counter) {
					return _this.counters[counter].pop();
				});
			};
			CounterState$1.prototype.parse = function(style) {
				var _this = this;
				var counterIncrement$1 = style.counterIncrement;
				var counterReset$1 = style.counterReset;
				var canReset = true;
				if (counterIncrement$1 !== null) counterIncrement$1.forEach(function(entry) {
				...
				var counterNames = [];
				if (canReset) counterReset$1.forEach(function(entry) {
					var counter = _this.counters[entry.counter];
		...
		var DocumentCloner = function() {
			function DocumentCloner$1(context, element, options) {
				this.context = context;
			...
			DocumentCloner$1.prototype.toIFrame = function(ownerDocument, windowSize) {
				var _this = this;
			...
			DocumentCloner$1.prototype.createElementClone = function(node) {
			...
			DocumentCloner$1.prototype.createCustomElementClone = function(node) {
				var clone = document.createElement("html2canvascustomelement");
				copyCSSStyles(node.style, clone);
				return clone;
			};
			DocumentCloner$1.prototype.createStyleClone = function(node) {
				try {
					var sheet = node.sheet;
					if (sheet && sheet.cssRules) {
						var css = [].slice.call(sheet.cssRules, 0).reduce(function(css$1, rule) {
							if (rule && typeof rule.cssText === "string") return css$1 + rule.cssText;
							return css$1;
						}, "");
					...
					this.context.logger.error("Unable to access cssRules property", e$1);
					if (e$1.name !== "SecurityError") throw e$1;
				}
				return node.cloneNode(false);
			};
			DocumentCloner$1.prototype.createCanvasClone = function(canvas) {
				var _a;
			...
			DocumentCloner$1.prototype.createVideoClone = function(video) {
			...
			DocumentCloner$1.prototype.appendChildNode = function(clone, child, copyStyles) {
			...
			DocumentCloner$1.prototype.cloneChildNodes = function(node, clone, copyStyles) {
				var _this = this;
			...
			DocumentCloner$1.prototype.cloneNode = function(node, copyStyles) {
				if (isTextNode(node)) return document.createTextNode(node.data);
				if (!node.ownerDocument) return node.cloneNode(false);
				var window$1 = node.ownerDocument.defaultView;
				if (window$1 && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
					var clone = this.createElementClone(node);
					clone.style.transitionProperty = "none";
					var style = window$1.getComputedStyle(node);
					var styleBefore = window$1.getComputedStyle(node, ":before");
					var styleAfter = window$1.getComputedStyle(node, ":after");
			...
			DocumentCloner$1.prototype.resolvePseudoContent = function(node, clone, style, pseudoElt) {
				var _this = this;
				if (!style) return;
				var value = style.content;
				var document$1 = clone.ownerDocument;
				if (!document$1 || !value || value === "none" || value === "-moz-alt-content" || style.display === "none") return;
				this.counters.parse(new CSSParsedCounterDeclaration(this.context, style));
				var declaration = new CSSParsedPseudoDeclaration(this.context, style);
				var anonymousReplacedElement = document$1.createElement("html2canvaspseudoelement");
				copyCSSStyles(style, anonymousReplacedElement);
				declaration.content.forEach(function(token) {
					if (token.type === 0) anonymousReplacedElement.appendChild(document$1.createTextNode(token.value));
						...
						if (token.name === "attr") {
							...
							if (attr.length) anonymousReplacedElement.appendChild(document$1.createTextNode(node.getAttribute(attr[0].value) || ""));
						} else if (token.name === "counter") {
							var _a = token.values.filter(nonFunctionArgSeparator), counter = _a[0], counterStyle = _a[1];
							if (counter && isIdentToken(counter)) {
								var counterState = _this.counters.getCounterValue(counter.value);
								var counterType = counterStyle && isIdentToken(counterStyle) ? listStyleType.parse(_this.context, counterStyle.value) : 3;
								anonymousReplacedElement.appendChild(document$1.createTextNode(createCounterText(counterState, counterType, false)));
							}
							...
							if (counter && isIdentToken(counter)) {
								...
								var text = counterStates.map(function(value$1) {
									return createCounterText(value$1, counterType_1, false);
								}).join(separator);
								anonymousReplacedElement.appendChild(document$1.createTextNode(text));
							}
						}
					} else if (token.type === 20) switch (token.value) {
						case "open-quote":
							anonymousReplacedElement.appendChild(document$1.createTextNode(getQuote(declaration.quotes, _this.quoteDepth++, true)));
							break;
						case "close-quote":
							anonymousReplacedElement.appendChild(document$1.createTextNode(getQuote(declaration.quotes, --_this.quoteDepth, false)));
							break;
						default: anonymousReplacedElement.appendChild(document$1.createTextNode(token.value));
					}
				});
			...
			DocumentCloner$1.destroy = function(container) {
			...
			return DocumentCloner$1;
		}();
		var PseudoElementType;
		(function(PseudoElementType$1) {
			PseudoElementType$1[PseudoElementType$1["BEFORE"] = 0] = "BEFORE";
			PseudoElementType$1[PseudoElementType$1["AFTER"] = 1] = "AFTER";
		...
		var imagesReady = function(document$1) {
			return Promise.all([].slice.call(document$1.images, 0).map(imageReady));
		};
		...
		var copyCSSStyles = function(style, target) {
			for (var i$4 = style.length - 1; i$4 >= 0; i$4--) {
				var property = style.item(i$4);
		...
		var createStyles = function(body, styles) {
			var document$1 = body.ownerDocument;
			if (document$1) {
		...
		var CacheStorage = function() {
			function CacheStorage$1() {}
			CacheStorage$1.getOrigin = function(url) {
				var link = CacheStorage$1._link;
				if (!link) return "about:blank";
				link.href = url;
				link.href = link.href;
				return link.protocol + link.hostname + link.port;
			};
			CacheStorage$1.isSameOrigin = function(src) {
				return CacheStorage$1.getOrigin(src) === CacheStorage$1._origin;
			};
			CacheStorage$1.setContext = function(window$1) {
				CacheStorage$1._link = window$1.document.createElement("a");
				CacheStorage$1._origin = CacheStorage$1.getOrigin(window$1.location.href);
			};
			CacheStorage$1._origin = "about:blank";
			return CacheStorage$1;
		}();
		var Cache = function() {
			function Cache$1(context, _options) {
				this.context = context;
				this._options = _options;
				this._cache = {};
			}
			Cache$1.prototype.addImage = function(src) {
			...
			Cache$1.prototype.match = function(src) {
				return this._cache[src];
			};
			Cache$1.prototype.loadImage = function(key) {
			...
			Cache$1.prototype.has = function(key) {
				return typeof this._cache[key] !== "undefined";
			};
			Cache$1.prototype.keys = function() {
				return Promise.resolve(Object.keys(this._cache));
			};
			Cache$1.prototype.proxy = function(src) {
				var _this = this;
				...
				return new Promise(function(resolve, reject) {
					...
					xhr.onload = function() {
						if (xhr.status === 200) if (responseType === "text") resolve(xhr.response);
							...
							reader_1.addEventListener("error", function(e$1) {
								return reject(e$1);
							}, false);
		...
		var Vector = function() {
			...
			Vector$1.prototype.add = function(deltaX, deltaY) {
				return new Vector$1(this.x + deltaX, this.y + deltaY);
			};
			return Vector$1;
		}();
		var lerp = function(a$1, b, t) {
			return new Vector(a$1.x + (b.x - a$1.x) * t, a$1.y + (b.y - a$1.y) * t);
		};
		var BezierCurve = function() {
			function BezierCurve$1(start, startControl, endControl, end) {
				this.type = 1;
				this.start = start;
			...
			BezierCurve$1.prototype.subdivide = function(t, firstHalf) {
				...
				return firstHalf ? new BezierCurve$1(this.start, ab, abbc, dest) : new BezierCurve$1(dest, bccd, cd, this.end);
			};
			BezierCurve$1.prototype.add = function(deltaX, deltaY) {
				return new BezierCurve$1(this.start.add(deltaX, deltaY), this.startControl.add(deltaX, deltaY), this.endControl.add(deltaX, deltaY), this.end.add(deltaX, deltaY));
			};
			BezierCurve$1.prototype.reverse = function() {
				return new BezierCurve$1(this.end, this.endControl, this.startControl, this.start);
			};
		...
		var BoundCurves = function() {
			function BoundCurves$1(element) {
				...
				var borderTopWidth$1 = styles.borderTopWidth;
				var borderRightWidth$1 = styles.borderRightWidth;
				var borderBottomWidth$1 = styles.borderBottomWidth;
				var borderLeftWidth$1 = styles.borderLeftWidth;
				var paddingTop$1 = getAbsoluteValue(styles.paddingTop, element.bounds.width);
				var paddingRight$1 = getAbsoluteValue(styles.paddingRight, element.bounds.width);
				var paddingBottom$1 = getAbsoluteValue(styles.paddingBottom, element.bounds.width);
				var paddingLeft$1 = getAbsoluteValue(styles.paddingLeft, element.bounds.width);
				this.topLeftBorderDoubleOuterBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 / 3, bounds.top + borderTopWidth$1 / 3, tlh - borderLeftWidth$1 / 3, tlv - borderTopWidth$1 / 3, CORNER.TOP_LEFT) : new Vector(bounds.left + borderLeftWidth$1 / 3, bounds.top + borderTopWidth$1 / 3);
				this.topRightBorderDoubleOuterBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + topWidth, bounds.top + borderTopWidth$1 / 3, trh - borderRightWidth$1 / 3, trv - borderTopWidth$1 / 3, CORNER.TOP_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 / 3, bounds.top + borderTopWidth$1 / 3);
				this.bottomRightBorderDoubleOuterBox = brh > 0 || brv > 0 ? getCurvePoints(bounds.left + bottomWidth, bounds.top + rightHeight, brh - borderRightWidth$1 / 3, brv - borderBottomWidth$1 / 3, CORNER.BOTTOM_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 / 3, bounds.top + bounds.height - borderBottomWidth$1 / 3);
				this.bottomLeftBorderDoubleOuterBox = blh > 0 || blv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 / 3, bounds.top + leftHeight, blh - borderLeftWidth$1 / 3, blv - borderBottomWidth$1 / 3, CORNER.BOTTOM_LEFT) : new Vector(bounds.left + borderLeftWidth$1 / 3, bounds.top + bounds.height - borderBottomWidth$1 / 3);
				this.topLeftBorderDoubleInnerBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 * 2 / 3, bounds.top + borderTopWidth$1 * 2 / 3, tlh - borderLeftWidth$1 * 2 / 3, tlv - borderTopWidth$1 * 2 / 3, CORNER.TOP_LEFT) : new Vector(bounds.left + borderLeftWidth$1 * 2 / 3, bounds.top + borderTopWidth$1 * 2 / 3);
				this.topRightBorderDoubleInnerBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + topWidth, bounds.top + borderTopWidth$1 * 2 / 3, trh - borderRightWidth$1 * 2 / 3, trv - borderTopWidth$1 * 2 / 3, CORNER.TOP_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 * 2 / 3, bounds.top + borderTopWidth$1 * 2 / 3);
				this.bottomRightBorderDoubleInnerBox = brh > 0 || brv > 0 ? getCurvePoints(bounds.left + bottomWidth, bounds.top + rightHeight, brh - borderRightWidth$1 * 2 / 3, brv - borderBottomWidth$1 * 2 / 3, CORNER.BOTTOM_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 * 2 / 3, bounds.top + bounds.height - borderBottomWidth$1 * 2 / 3);
				this.bottomLeftBorderDoubleInnerBox = blh > 0 || blv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 * 2 / 3, bounds.top + leftHeight, blh - borderLeftWidth$1 * 2 / 3, blv - borderBottomWidth$1 * 2 / 3, CORNER.BOTTOM_LEFT) : new Vector(bounds.left + borderLeftWidth$1 * 2 / 3, bounds.top + bounds.height - borderBottomWidth$1 * 2 / 3);
				this.topLeftBorderStroke = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 / 2, bounds.top + borderTopWidth$1 / 2, tlh - borderLeftWidth$1 / 2, tlv - borderTopWidth$1 / 2, CORNER.TOP_LEFT) : new Vector(bounds.left + borderLeftWidth$1 / 2, bounds.top + borderTopWidth$1 / 2);
				this.topRightBorderStroke = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + topWidth, bounds.top + borderTopWidth$1 / 2, trh - borderRightWidth$1 / 2, trv - borderTopWidth$1 / 2, CORNER.TOP_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 / 2, bounds.top + borderTopWidth$1 / 2);
				this.bottomRightBorderStroke = brh > 0 || brv > 0 ? getCurvePoints(bounds.left + bottomWidth, bounds.top + rightHeight, brh - borderRightWidth$1 / 2, brv - borderBottomWidth$1 / 2, CORNER.BOTTOM_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1 / 2, bounds.top + bounds.height - borderBottomWidth$1 / 2);
				this.bottomLeftBorderStroke = blh > 0 || blv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 / 2, bounds.top + leftHeight, blh - borderLeftWidth$1 / 2, blv - borderBottomWidth$1 / 2, CORNER.BOTTOM_LEFT) : new Vector(bounds.left + borderLeftWidth$1 / 2, bounds.top + bounds.height - borderBottomWidth$1 / 2);
				...
				this.topLeftPaddingBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1, bounds.top + borderTopWidth$1, Math.max(0, tlh - borderLeftWidth$1), Math.max(0, tlv - borderTopWidth$1), CORNER.TOP_LEFT) : new Vector(bounds.left + borderLeftWidth$1, bounds.top + borderTopWidth$1);
				this.topRightPaddingBox = trh > 0 || trv > 0 ? getCurvePoints(bounds.left + Math.min(topWidth, bounds.width - borderRightWidth$1), bounds.top + borderTopWidth$1, topWidth > bounds.width + borderRightWidth$1 ? 0 : Math.max(0, trh - borderRightWidth$1), Math.max(0, trv - borderTopWidth$1), CORNER.TOP_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1, bounds.top + borderTopWidth$1);
				this.bottomRightPaddingBox = brh > 0 || brv > 0 ? getCurvePoints(bounds.left + Math.min(bottomWidth, bounds.width - borderLeftWidth$1), bounds.top + Math.min(rightHeight, bounds.height - borderBottomWidth$1), Math.max(0, brh - borderRightWidth$1), Math.max(0, brv - borderBottomWidth$1), CORNER.BOTTOM_RIGHT) : new Vector(bounds.left + bounds.width - borderRightWidth$1, bounds.top + bounds.height - borderBottomWidth$1);
				this.bottomLeftPaddingBox = blh > 0 || blv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1, bounds.top + Math.min(leftHeight, bounds.height - borderBottomWidth$1), Math.max(0, blh - borderLeftWidth$1), Math.max(0, blv - borderBottomWidth$1), CORNER.BOTTOM_LEFT) : new Vector(bounds.left + borderLeftWidth$1, bounds.top + bounds.height - borderBottomWidth$1);
				this.topLeftContentBox = tlh > 0 || tlv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 + paddingLeft$1, bounds.top + borderTopWidth$1 + paddingTop$1, Math.max(0, tlh - (borderLeftWidth$1 + paddingLeft$1)), Math.max(0, tlv - (borderTopWidth$1 + paddingTop$1)), CORNER.TOP_LEFT) : new Vector(bounds.left + borderLeftWidth$1 + paddingLeft$1, bounds.top + borderTopWidth$1 + paddingTop$1);
				this.topRightContentBox = trh > 0 || trv > 0 ? getCurvePoints(bounds.left + Math.min(topWidth, bounds.width + borderLeftWidth$1 + paddingLeft$1), bounds.top + borderTopWidth$1 + paddingTop$1, topWidth > bounds.width + borderLeftWidth$1 + paddingLeft$1 ? 0 : trh - borderLeftWidth$1 + paddingLeft$1, trv - (borderTopWidth$1 + paddingTop$1), CORNER.TOP_RIGHT) : new Vector(bounds.left + bounds.width - (borderRightWidth$1 + paddingRight$1), bounds.top + borderTopWidth$1 + paddingTop$1);
				this.bottomRightContentBox = brh > 0 || brv > 0 ? getCurvePoints(bounds.left + Math.min(bottomWidth, bounds.width - (borderLeftWidth$1 + paddingLeft$1)), bounds.top + Math.min(rightHeight, bounds.height + borderTopWidth$1 + paddingTop$1), Math.max(0, brh - (borderRightWidth$1 + paddingRight$1)), brv - (borderBottomWidth$1 + paddingBottom$1), CORNER.BOTTOM_RIGHT) : new Vector(bounds.left + bounds.width - (borderRightWidth$1 + paddingRight$1), bounds.top + bounds.height - (borderBottomWidth$1 + paddingBottom$1));
				this.bottomLeftContentBox = blh > 0 || blv > 0 ? getCurvePoints(bounds.left + borderLeftWidth$1 + paddingLeft$1, bounds.top + leftHeight, Math.max(0, blh - (borderLeftWidth$1 + paddingLeft$1)), blv - (borderBottomWidth$1 + paddingBottom$1), CORNER.BOTTOM_LEFT) : new Vector(bounds.left + borderLeftWidth$1 + paddingLeft$1, bounds.top + bounds.height - (borderBottomWidth$1 + paddingBottom$1));
			}
			return BoundCurves$1;
		}();
		var CORNER;
		(function(CORNER$1) {
			CORNER$1[CORNER$1["TOP_LEFT"] = 0] = "TOP_LEFT";
			CORNER$1[CORNER$1["TOP_RIGHT"] = 1] = "TOP_RIGHT";
			CORNER$1[CORNER$1["BOTTOM_RIGHT"] = 2] = "BOTTOM_RIGHT";
			CORNER$1[CORNER$1["BOTTOM_LEFT"] = 3] = "BOTTOM_LEFT";
		})(CORNER || (CORNER = {}));
		var getCurvePoints = function(x, y, r1, r2, position$1) {
		...
		var TransformEffect = function() {
			function TransformEffect$1(offsetX, offsetY, matrix$1) {
				this.offsetX = offsetX;
				this.offsetY = offsetY;
				this.matrix = matrix$1;
				this.type = 0;
				this.target = 6;
			}
			return TransformEffect$1;
		}();
		var ClipEffect = function() {
			function ClipEffect$1(path, target) {
				this.path = path;
				this.target = target;
				this.type = 1;
			}
		...
		var OpacityEffect = function() {
			function OpacityEffect$1(opacity$1) {
				this.opacity = opacity$1;
				this.type = 2;
				this.target = 6;
			}
			return OpacityEffect$1;
		}();
		...
		var equalPath = function(a$1, b) {
			if (a$1.length === b.length) return a$1.some(function(v, i$4) {
				return v === b[i$4];
			});
			return false;
		};
		...
		var StackingContext = function() {
			function StackingContext$1(container) {
			...
			return StackingContext$1;
		}();
		var ElementPaint = function() {
			function ElementPaint$1(container, parent) {
				...
				if (this.container.styles.transform !== null) {
					...
					var matrix$1 = this.container.styles.transform;
					this.effects.push(new TransformEffect(offsetX, offsetY, matrix$1));
				}
				if (this.container.styles.overflowX !== 0) {
					var borderBox = calculateBorderBoxPath(this.curves);
					var paddingBox$1 = calculatePaddingBoxPath(this.curves);
					if (equalPath(borderBox, paddingBox$1)) this.effects.push(new ClipEffect(borderBox, 6));
					else {
						this.effects.push(new ClipEffect(borderBox, 2));
						this.effects.push(new ClipEffect(paddingBox$1, 4));
					}
				}
			}
			ElementPaint$1.prototype.getEffects = function(target) {
				...
				while (parent) {
					...
					if (inFlow || parent.container.styles.position !== 0 || !parent.parent) {
						...
						if (parent.container.styles.overflowX !== 0) {
							...
							var paddingBox$1 = calculatePaddingBoxPath(parent.curves);
							if (!equalPath(borderBox, paddingBox$1)) effects.unshift(new ClipEffect(paddingBox$1, 6));
						}
		...
		var parseStackTree = function(parent, stackingContext, realStackingContext, listItems) {
			parent.container.elements.forEach(function(child) {
				...
				if (treatAsRealStackingContext || createsStackingContext$1) {
					...
					if (child.styles.isPositioned() || child.styles.opacity < 1 || child.styles.isTransformed()) {
						...
						if (order_1 < 0) {
							var index_1 = 0;
							parentStack.negativeZIndex.some(function(current, i$4) {
							...
							var index_2 = 0;
							parentStack.positiveZIndex.some(function(current, i$4) {
								if (order_1 >= current.element.container.styles.zIndex.order) {
									index_2 = i$4 + 1;
									return false;
		...
		var processListItems = function(owner, elements) {
			...
			for (var i$4 = 0; i$4 < elements.length; i$4++) {
				var item = elements[i$4];
		...
		var contentBox = function(element) {
			var styles = element.styles;
			var bounds = element.bounds;
			var paddingLeft$1 = getAbsoluteValue(styles.paddingLeft, bounds.width);
			var paddingRight$1 = getAbsoluteValue(styles.paddingRight, bounds.width);
			var paddingTop$1 = getAbsoluteValue(styles.paddingTop, bounds.width);
			var paddingBottom$1 = getAbsoluteValue(styles.paddingBottom, bounds.width);
			return bounds.add(paddingLeft$1 + styles.borderLeftWidth, paddingTop$1 + styles.borderTopWidth, -(styles.borderRightWidth + styles.borderLeftWidth + paddingLeft$1 + paddingRight$1), -(styles.borderTopWidth + styles.borderBottomWidth + paddingTop$1 + paddingBottom$1));
		};
		var calculateBackgroundPositioningArea = function(backgroundOrigin$1, element) {
			if (backgroundOrigin$1 === 0) return element.bounds;
			if (backgroundOrigin$1 === 2) return contentBox(element);
			return paddingBox(element);
		};
		var calculateBackgroundPaintingArea = function(backgroundClip$1, element) {
			if (backgroundClip$1 === 0) return element.bounds;
			if (backgroundClip$1 === 2) return contentBox(element);
			return paddingBox(element);
		};
		var calculateBackgroundRendering = function(container, index, intrinsicSize) {
			...
			var position$1 = getAbsoluteValueForTuple(getBackgroundValueForIndex(container.styles.backgroundPosition, index), backgroundPositioningArea.width - sizeWidth, backgroundPositioningArea.height - sizeHeight);
			return [
				calculateBackgroundRepeatPath(getBackgroundValueForIndex(container.styles.backgroundRepeat, index), position$1, backgroundImageSize, backgroundPositioningArea, backgroundPaintingArea),
				Math.round(backgroundPositioningArea.left + position$1[0]),
				Math.round(backgroundPositioningArea.top + position$1[1]),
				sizeWidth,
				sizeHeight
			];
		};
		...
		var FontMetrics = function() {
			function FontMetrics$1(document$1) {
				this._data = {};
				this._document = document$1;
			}
			FontMetrics$1.prototype.parseMetrics = function(fontFamily$1, fontSize$1) {
				var container = this._document.createElement("div");
				var img = this._document.createElement("img");
				var span = this._document.createElement("span");
				var body = this._document.body;
				container.style.visibility = "hidden";
				container.style.fontFamily = fontFamily$1;
				container.style.fontSize = fontSize$1;
				...
				span.style.fontFamily = fontFamily$1;
			...
			FontMetrics$1.prototype.getMetrics = function(fontFamily$1, fontSize$1) {
				var key = fontFamily$1 + " " + fontSize$1;
				if (typeof this._data[key] === "undefined") this._data[key] = this.parseMetrics(fontFamily$1, fontSize$1);
				return this._data[key];
			};
			return FontMetrics$1;
		}();
		var Renderer = function() {
			function Renderer$1(context, options) {
				this.context = context;
				this.options = options;
			}
			return Renderer$1;
		...
		var CanvasRenderer = function(_super) {
			__extends(CanvasRenderer$1, _super);
			function CanvasRenderer$1(context, options) {
			...
			CanvasRenderer$1.prototype.applyEffects = function(effects) {
				var _this = this;
			...
			CanvasRenderer$1.prototype.applyEffect = function(effect) {
				this.ctx.save();
			...
			CanvasRenderer$1.prototype.popEffect = function() {
				this._activeEffects.pop();
				this.ctx.restore();
			};
			CanvasRenderer$1.prototype.renderStack = function(stack) {
				return __awaiter(this, void 0, void 0, function() {
					var styles;
					return __generator(this, function(_a) {
						switch (_a.label) {
			...
			CanvasRenderer$1.prototype.renderNode = function(paint) {
				return __awaiter(this, void 0, void 0, function() {
					return __generator(this, function(_a) {
						switch (_a.label) {
							case 0:
			...
			CanvasRenderer$1.prototype.renderTextWithLetterSpacing = function(text, letterSpacing$1, baseline) {
				var _this = this;
				if (letterSpacing$1 === 0) this.ctx.fillText(text.text, text.bounds.left, text.bounds.top + baseline);
				else segmentGraphemes(text.text).reduce(function(left, letter) {
					_this.ctx.fillText(letter, left, text.bounds.top + baseline);
					return left + _this.ctx.measureText(letter).width;
				}, text.bounds.left);
			};
			CanvasRenderer$1.prototype.createFontStyle = function(styles) {
				var fontVariant$1 = styles.fontVariant.filter(function(variant) {
					return variant === "normal" || variant === "small-caps";
				}).join("");
				var fontFamily$1 = fixIOSSystemFonts(styles.fontFamily).join(", ");
				var fontSize$1 = isDimensionToken(styles.fontSize) ? "" + styles.fontSize.number + styles.fontSize.unit : styles.fontSize.number + "px";
				return [
					[
						styles.fontStyle,
						fontVariant$1,
			...
			CanvasRenderer$1.prototype.renderTextNode = function(text, styles) {
				return __awaiter(this, void 0, void 0, function() {
					var _a, font, fontFamily$1, fontSize$1, _b, baseline, middle, paintOrder$1;
					var _this = this;
					return __generator(this, function(_c) {
						_a = this.createFontStyle(styles), font = _a[0], fontFamily$1 = _a[1], fontSize$1 = _a[2];
						this.ctx.font = font;
						this.ctx.direction = styles.direction === 1 ? "rtl" : "ltr";
						this.ctx.textAlign = "left";
						this.ctx.textBaseline = "alphabetic";
						_b = this.fontMetrics.getMetrics(fontFamily$1, fontSize$1), baseline = _b.baseline, middle = _b.middle;
						paintOrder$1 = styles.paintOrder;
						text.textBounds.forEach(function(text$1) {
							paintOrder$1.forEach(function(paintOrderLayer) {
								switch (paintOrderLayer) {
									case 0:
										_this.ctx.fillStyle = asString(styles.color);
										_this.renderTextWithLetterSpacing(text$1, styles.letterSpacing, baseline);
										var textShadows = styles.textShadow;
										if (textShadows.length && text$1.text.trim().length) {
											textShadows.slice(0).reverse().forEach(function(textShadow$1) {
												_this.ctx.shadowColor = asString(textShadow$1.color);
												_this.ctx.shadowOffsetX = textShadow$1.offsetX.number * _this.options.scale;
												_this.ctx.shadowOffsetY = textShadow$1.offsetY.number * _this.options.scale;
												_this.ctx.shadowBlur = textShadow$1.blur.number;
												_this.renderTextWithLetterSpacing(text$1, styles.letterSpacing, baseline);
											});
										...
										if (styles.textDecorationLine.length) {
											...
											styles.textDecorationLine.forEach(function(textDecorationLine$1) {
												switch (textDecorationLine$1) {
													case 1:
														_this.ctx.fillRect(text$1.bounds.left, Math.round(text$1.bounds.top + baseline), text$1.bounds.width, 1);
														break;
													case 2:
														_this.ctx.fillRect(text$1.bounds.left, Math.round(text$1.bounds.top), text$1.bounds.width, 1);
														break;
													case 3:
														_this.ctx.fillRect(text$1.bounds.left, Math.ceil(text$1.bounds.top + middle), text$1.bounds.width, 1);
														break;
												}
											});
										}
										break;
									case 1:
										if (styles.webkitTextStrokeWidth && text$1.text.trim().length) {
											_this.ctx.strokeStyle = asString(styles.webkitTextStrokeColor);
											_this.ctx.lineWidth = styles.webkitTextStrokeWidth;
											_this.ctx.lineJoin = !!window.chrome ? "miter" : "round";
											_this.ctx.strokeText(text$1.text, text$1.bounds.left, text$1.bounds.top + baseline);
										}
			...
			CanvasRenderer$1.prototype.renderReplacedElement = function(container, curves, image$1) {
				if (image$1 && container.intrinsicWidth > 0 && container.intrinsicHeight > 0) {
					var box = contentBox(container);
					var path = calculatePaddingBoxPath(curves);
					this.path(path);
					this.ctx.save();
					this.ctx.clip();
					this.ctx.drawImage(image$1, 0, 0, container.intrinsicWidth, container.intrinsicHeight, box.left, box.top, box.width, box.height);
					this.ctx.restore();
				}
			};
			CanvasRenderer$1.prototype.renderNodeContent = function(paint) {
				return __awaiter(this, void 0, void 0, function() {
					var container, curves, styles, _i, _a, child, image$1, image$1, iframeRenderer, canvas, size, _b, fontFamily$1, fontSize$1, baseline, bounds, x, textBounds, img, image$1, url, fontFamily$1, bounds;
					return __generator(this, function(_c) {
						switch (_c.label) {
							case 0:
							...
							case 6:
								image$1 = _c.sent();
								this.renderReplacedElement(container, curves, image$1);
								return [3, 8];
							case 7:
								_c.sent();
							...
							case 12:
								...
								iframeRenderer = new CanvasRenderer$1(this.context, {
							...
							case 14:
								...
								if (isTextInputElement(container) && container.value.length) {
									_b = this.createFontStyle(styles), fontFamily$1 = _b[0], fontSize$1 = _b[1];
									baseline = this.fontMetrics.getMetrics(fontFamily$1, fontSize$1).baseline;
									this.ctx.font = fontFamily$1;
							...
							case 16:
								image$1 = _c.sent();
								this.ctx.drawImage(image$1, container.bounds.left - (image$1.width + 10), container.bounds.top);
								return [3, 18];
							case 17:
								_c.sent();
							...
							case 19:
								if (paint.listValue && container.styles.listStyleType !== -1) {
									fontFamily$1 = this.createFontStyle(styles)[0];
									this.ctx.font = fontFamily$1;
									this.ctx.fillStyle = asString(styles.color);
			...
			CanvasRenderer$1.prototype.renderStackContent = function(stack) {
				return __awaiter(this, void 0, void 0, function() {
			...
			CanvasRenderer$1.prototype.mask = function(paths) {
				this.ctx.beginPath();
				this.ctx.moveTo(0, 0);
			...
			CanvasRenderer$1.prototype.path = function(paths) {
				this.ctx.beginPath();
				this.formatPath(paths);
				this.ctx.closePath();
			};
			CanvasRenderer$1.prototype.formatPath = function(paths) {
				var _this = this;
			...
			CanvasRenderer$1.prototype.renderRepeat = function(path, pattern, offsetX, offsetY) {
				this.path(path);
			...
			CanvasRenderer$1.prototype.resizeImage = function(image$1, width, height) {
				var _a;
				if (image$1.width === width && image$1.height === height) return image$1;
				var canvas = ((_a = this.canvas.ownerDocument) !== null && _a !== void 0 ? _a : document).createElement("canvas");
				canvas.width = Math.max(1, width);
				canvas.height = Math.max(1, height);
				canvas.getContext("2d").drawImage(image$1, 0, 0, image$1.width, image$1.height, 0, 0, width, height);
				return canvas;
			};
			CanvasRenderer$1.prototype.renderBackgroundImage = function(container) {
				return __awaiter(this, void 0, void 0, function() {
					var index, _loop_1, this_1, _i, _a, backgroundImage$1;
					return __generator(this, function(_b) {
						switch (_b.label) {
							case 0:
								index = container.styles.backgroundImage.length - 1;
								_loop_1 = function(backgroundImage$2) {
									var image$1, url, _c, path, x, y, width, height, pattern, _d, path, x, y, width, height, _e, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_1, pattern, _f, path, left, top_1, width, height, position$1, x, y, _g, rx, ry, radialGradient_1, midX, midY, f$1, invF;
									return __generator(this, function(_h) {
										switch (_h.label) {
											case 0:
												if (!(backgroundImage$2.type === 0)) return [3, 5];
												image$1 = void 0;
												url = backgroundImage$2.url;
												_h.label = 1;
											case 1:
												_h.trys.push([
													1,
											...
											case 4:
												if (image$1) {
													_c = calculateBackgroundRendering(container, index, [
														image$1.width,
														image$1.height,
														image$1.width / image$1.height
													]), path = _c[0], x = _c[1], y = _c[2], width = _c[3], height = _c[4];
													pattern = this_1.ctx.createPattern(this_1.resizeImage(image$1, width, height), "repeat");
													this_1.renderRepeat(path, pattern, x, y);
												}
												return [3, 6];
											case 5:
												if (isLinearGradient(backgroundImage$2)) {
													_d = calculateBackgroundRendering(container, index, [
														null,
														null,
														null
													]), path = _d[0], x = _d[1], y = _d[2], width = _d[3], height = _d[4];
													_e = calculateGradientDirection(backgroundImage$2.angle, width, height), lineLength = _e[0], x0 = _e[1], x1 = _e[2], y0 = _e[3], y1 = _e[4];
													canvas = document.createElement("canvas");
													canvas.width = width;
													canvas.height = height;
													ctx = canvas.getContext("2d");
													gradient_1 = ctx.createLinearGradient(x0, y0, x1, y1);
													processColorStops(backgroundImage$2.stops, lineLength).forEach(function(colorStop) {
												...
												} else if (isRadialGradient(backgroundImage$2)) {
													_f = calculateBackgroundRendering(container, index, [
														null,
														null,
														null
													]), path = _f[0], left = _f[1], top_1 = _f[2], width = _f[3], height = _f[4];
													position$1 = backgroundImage$2.position.length === 0 ? [FIFTY_PERCENT] : backgroundImage$2.position;
													x = getAbsoluteValue(position$1[0], width);
													y = getAbsoluteValue(position$1[position$1.length - 1], height);
													_g = calculateRadius(backgroundImage$2, x, y, width, height), rx = _g[0], ry = _g[1];
													if (rx > 0 && ry > 0) {
														radialGradient_1 = this_1.ctx.createRadialGradient(left + x, top_1 + y, 0, left + x, top_1 + y, rx);
														processColorStops(backgroundImage$2.stops, rx * 2).forEach(function(colorStop) {
														...
														if (rx !== ry) {
															...
															this_1.ctx.transform(1, 0, 0, f$1, 0, 0);
															this_1.ctx.translate(-midX, -midY);
							...
							case 1:
								if (!(_i < _a.length)) return [3, 4];
								backgroundImage$1 = _a[_i];
								return [5, _loop_1(backgroundImage$1)];
							case 2:
								_b.sent();
								_b.label = 3;
							case 3:
			...
			CanvasRenderer$1.prototype.renderSolidBorder = function(color$2, side, curvePoints) {
				return __awaiter(this, void 0, void 0, function() {
					return __generator(this, function(_a) {
						this.path(parsePathForBorder(curvePoints, side));
						this.ctx.fillStyle = asString(color$2);
						this.ctx.fill();
						return [2];
					});
				});
			};
			CanvasRenderer$1.prototype.renderDoubleBorder = function(color$2, width, side, curvePoints) {
				return __awaiter(this, void 0, void 0, function() {
					...
					return __generator(this, function(_a) {
						switch (_a.label) {
							case 0:
								...
								return [4, this.renderSolidBorder(color$2, side, curvePoints)];
							case 1:
								_a.sent();
								return [2];
							case 2:
			...
			CanvasRenderer$1.prototype.renderNodeBackgroundAndBorders = function(paint) {
				return __awaiter(this, void 0, void 0, function() {
			...
			CanvasRenderer$1.prototype.renderDashedDottedBorder = function(color$2, width, side, curvePoints, style) {
				return __awaiter(this, void 0, void 0, function() {
					...
					return __generator(this, function(_a) {
						...
						this.ctx.strokeStyle = asString(color$2);
						this.ctx.stroke();
			...
			CanvasRenderer$1.prototype.render = function(element) {
				return __awaiter(this, void 0, void 0, function() {
					var stack;
					return __generator(this, function(_a) {
						switch (_a.label) {
		...
		var canvasTextAlign = function(textAlign$1) {
			switch (textAlign$1) {
		...
		var fixIOSSystemFonts = function(fontFamilies) {
			return /iPhone OS 15_(0|1)/.test(window.navigator.userAgent) ? fontFamilies.filter(function(fontFamily$1) {
				return iOSBrokenFonts.indexOf(fontFamily$1) === -1;
			}) : fontFamilies;
		};
		var ForeignObjectRenderer = function(_super) {
			__extends(ForeignObjectRenderer$1, _super);
			function ForeignObjectRenderer$1(context, options) {
				var _this = _super.call(this, context, options) || this;
				_this.canvas = options.canvas ? options.canvas : document.createElement("canvas");
				_this.ctx = _this.canvas.getContext("2d");
			...
			ForeignObjectRenderer$1.prototype.render = function(element) {
				return __awaiter(this, void 0, void 0, function() {
					var svg, img;
					return __generator(this, function(_a) {
						switch (_a.label) {
			...
			return ForeignObjectRenderer$1;
		}(Renderer);
		...
		var Logger = function() {
			function Logger$1(_a) {
				var id = _a.id, enabled = _a.enabled;
				this.id = id;
				this.enabled = enabled;
				this.start = Date.now();
			}
			Logger$1.prototype.debug = function() {
				var args = [];
			...
			Logger$1.prototype.getTime = function() {
				return Date.now() - this.start;
			};
			Logger$1.prototype.info = function() {
				var args = [];
				for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
				if (this.enabled) {
			...
			Logger$1.prototype.warn = function() {
				var args = [];
				for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
			...
			Logger$1.prototype.error = function() {
				var args = [];
				for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
		...
		var Context = function() {
			function Context$1(options, windowBounds) {
				var _a;
				this.windowBounds = windowBounds;
				this.instanceName = "#" + Context$1.instanceCount++;
		...
		var renderElement = function(element, opts) {
			return __awaiter(void 0, void 0, void 0, function() {
				var ownerDocument, defaultView, resourceOptions, contextOptions, windowOptions, windowBounds, context, foreignObjectRendering, cloneOptions, documentCloner, clonedElement, container, _a, width, height, left, top, backgroundColor$1, renderOptions, canvas, renderer, root, renderer;
				...
				return __generator(this, function(_u) {
					switch (_u.label) {
						...
						case 1:
							...
							backgroundColor$1 = parseBackgroundColor(context, clonedElement, opts.backgroundColor);
							renderOptions = {
								canvas: opts.canvas,
						...
						case 3:
							...
							if (backgroundColor$1 === root.styles.backgroundColor) root.styles.backgroundColor = COLORS.TRANSPARENT;
...
//# sourceMappingURL=html2canvas-Bf3uaE4_.js.map